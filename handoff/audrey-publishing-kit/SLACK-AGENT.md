...
Use this zip when giving the runnable bot project to Audrey or a deployment operator:

```text
handoff/summit-digest-slack-app-bundle.zip
```

It contains the Slack app, publisher scripts, Design A seed issue, assets, docs, package files, and Dockerfile.
